# Postman Student API-First Hacktoberfest: API starter
...
## Build the Halloween Costume Contest API!

You have chosen to build an API 🎉! This API should allow users to create, read, update, delete, and upvote Halloween costume party contestants.

### Requirements

You can use ANY tech stack you want, as long is it matches the schema with 7 endpoints, and passes all the tests.
...
Get help in the Postman Student Community Discord server! Ask questions in the `#hacktoberfest-backend` channel, or join us at Office Hours. 
